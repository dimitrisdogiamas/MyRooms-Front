    ...
    <View style={styles.root}>
      ...
      {bookingInfo ? (
        <BookingInfoModal
          ...
          onEdit={(b) => {
            setBookingInfo(null);
            // Wait for Info Modal to finish closing before opening Form
            setTimeout(() => setEditingBooking(b), 350);
          }}
        />
      ) : null}
      ...
      {editingBooking ? (
        <BookingFormModal
          ...
          draft={{
            room:
              rooms.find((r) => r.id === editingBooking.room_id) ??
              ({
                id: editingBooking.room_id,
                name: "",
              } as (typeof rooms)[number]),
            startDate: editingBooking.start_date,
            endDate: editingBooking.end_date,
          }}
          roomPrices={roomPrices}
